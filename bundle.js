...
var Burgers = require('./pages/Burgers');
// endinject

var menuItems = [
  // inject:menuitems
  { payload: 'home', text: 'Home Page' },
  { payload: 'burgers', text: 'Yum Burgers' },
  // endinject
];
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
    ...
    React.createElement(Route, {name: "burgers", handler: Burgers}), 
    /* endinject */
...
},{"./pages/Burgers":250,"./pages/HomePage":251,"material-ui":7,"react":249,"react-router":50,"react-tap-event-plugin":87}],2:[function(require,module,exports){
/*!
...
module.exports = React.createClass({displayName: "exports",
  render: function () {
    return (
      React.createElement("div", {className: "burger-page"}, 
        React.createElement("h1", null, "Yum Burgers!!!!"), 
       	React.createElement("img", {src: "http://bnearme.com/wp-content/uploads/2015/01/Burger-Place-near-me.jpg"})
      )
    );
  }
  ...
  render: function () {
    return (
      React.createElement("div", {className: "home-page"}, 
        React.createElement("h1", null, "Home Page Content"), 
       	React.createElement("img", {src: "https://bargainhomebids.com/upload/files/1386310340-2400-sq-ft-home.jpg"})
      )
    );
  }
